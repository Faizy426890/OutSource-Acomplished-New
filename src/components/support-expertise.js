...
const SERVICES = [
  { title: "Inbound Calls", imgSrc: "https://cdn-icons-png.flaticon.com/512/3059/3059520.png", alt: "Inbound calls illustration" },
  {
    title: "Email Support",
  ...
  }, 
   {
    ...
    imgSrc: "https://static.vecteezy.com/system/resources/thumbnails/019/923/706/small/telephone-and-mobile-phone-icon-calling-icon-transparent-background-free-png.png",
    alt: "Outbound Calls Managing",
  },
  {
    title: "Live Chat",
    imgSrc: "https://cdn-icons-png.flaticon.com/512/2593/2593783.png",
  ...
  },
  {
    ...
    alt: "Complaint resolution illustration",
  },
]

const TABS = ["United States", "Europe", "Middle East"] 

const DESCRIPTIONS = {
  "Inbound Calls": "Professional call handling with script adherence, call routing, and comprehensive call logging for seamless customer interactions and issue resolution.",
  "Email Support": "Timely email responses with personalized solutions, ticket management, and follow-up tracking to ensure complete customer satisfaction.",
  "Live Chat": "Real-time chat support with quick response times, multi-tasking capabilities, and efficient problem-solving for immediate customer assistance.",
  "Technical Support": "Expert technical troubleshooting, product guidance, and step-by-step assistance for complex customer issues and technical inquiries.",
  "Complaint Resolution": "Skilled handling of customer complaints with empathy, conflict resolution techniques, and satisfactory outcomes to retain customer loyalty.",
  "Outbound Calls": "Our trained representatives ensure every call reflects your brand’s professionalism while driving engagement, sales, and customer satisfaction.",
}

export default function SupportExpertise() {
  ...
  return (
    <section className="wrap" aria-labelledby="expertise-heading">
      ...
      <ul className="grid" aria-label="Support services" onMouseLeave={() => setHovered(null)}>
        {SERVICES.map((s, idx) => {
