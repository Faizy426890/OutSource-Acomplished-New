                  ...
                  <div className="swiper-wrapper">
                    <SwiperSlide className="swiper-slide">
                      <div className="testimonial-card3 style-2">
                        ...
                        <p>
                          Working with this team on our music marketing website was a game-changer. They understood the unique needs of the music industry and delivered a sleek, high-performing platform tailored for artists and labels. The site not only looks great but is optimized for conversions and fan engagement.
                        </p>
                        <div className="author-and-logo-area">
                          <div className="author-area">
                            ...
                            <div className="content">
                              <h6>Ray Parker</h6>
                              <span>CEO At BrandBlitz.solutions</span>
                            </div>
                          </div>
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="testimonial-card3 style-2">
                        <span>Impressive  Work!</span>
                        <p>
                          "The team delivered an intuitive, reliable, and secure medical software solution tailored to our workflow. From patient data management to appointment scheduling, every feature was thoughtfully designed with compliance and ease of use in mind. Their deep understanding of healthcare challenges ensured the final product met both clinical and administrative needs. A highly professional and responsive team—we couldn’t be more satisfied"
                        </p>
                        <div className="author-and-logo-area">
                          <div className="author-area">
                            <div className="author-img">
                            ...
                            <div className="content">
                              <h6>Jasmel Costa</h6>
                              <span>CEO At aiscribers.com</span>
                            </div>
                          </div>
