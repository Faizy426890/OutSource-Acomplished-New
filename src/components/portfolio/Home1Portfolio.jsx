    ...
    <>
      <div className="portfolio-section mb-110">
              ...
              <Swiper {...settings} className="swiper portfolio-slider">
                <div className="swiper-wrapper">
                  <SwiperSlide className="swiper-slide">
                    <div className="eg-card">
                      <div className="card-img">
                        <img src="assets/img/home1/portfolio-img-01.jpg" alt="" />
                      </div>
                      <div className="card-content">
                        ...
                        <div className="catgory-and-title">
                          ...
                          <h5>
                            <Link href="/portfolio/portfolio-details">Management Consulting</Link>
                          </h5>
                        </div>
                      </div>
                    </div>
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="eg-card">
                      <div className="card-img">
                        <img src="assets/img/home1/portfolio-img-02.jpg" alt="" />
                      </div>
                      <div className="card-content">
                        <Link className="view-btn" href="/portfolio/portfolio-details">
                          <img src="assets/img/home1/right-arrow.png" alt="" />
                        ...
                        <div className="catgory-and-title">
                          ...
                          <h5>
                            <Link href="/portfolio/portfolio-details">Human Resources Consulting</Link>
                          </h5>
                        </div>
                      </div>
                    </div>
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="eg-card">
                      <div className="card-img">
                        <img src="assets/img/home1/portfolio-img-03.jpg" alt="" />
                      </div>
                      <div className="card-content">
                        <Link className="view-btn" href="/portfolio/portfolio-details">
                          <img src="assets/img/home1/right-arrow.png" alt="" />
                        ...
                        <div className="catgory-and-title">
                          ...
                          <h5>
                            <Link href="/portfolio/portfolio-details">IT Consulting</Link>
                          </h5>
                        </div>
                      </div>
                    </div>
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="eg-card">
                      <div className="card-img">
                        <img src="assets/img/home1/portfolio-img-04.jpg" alt="" />
                      </div>
                      <div className="card-content">
                        <Link className="view-btn" href="/portfolio/portfolio-details">
                          <img src="assets/img/home1/right-arrow.png" alt="" />
                        ...
                        <div className="catgory-and-title">
                          ...
                          <h5>
                            <Link href="/portfolio/portfolio-details">Finance Consulting</Link>
                          </h5>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="eg-card">
                      ...
                      <div className="card-content">
                        ...
                        <div className="catgory-and-title">
                          ...
                          <h5>
                            <Link href="/portfolio/portfolio-details">Human Resources</Link>
                          </h5>
                        </div>
                      </div>
                    </div>
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="eg-card">
                      <div className="card-img">
                        <img src="assets/img/home1/portfolio-img-06.jpg" alt="" />
                      </div>
                      <div className="card-content">
                        <Link className="view-btn" href="/portfolio/portfolio-details">
                          <img src="assets/img/home1/right-arrow.png" alt="" />
                        ...
                        <div className="catgory-and-title">
                          ...
                          <h5>
                            <Link href="/portfolio/portfolio-details">Health Care Consult</Link>
                          </h5>
                        </div>
                      </div>
                    </div>
        ...
        <style jsx>
          ...
          /* Ensure all image boxes are the same size regardless of content */
          .swiper-slide {
            height: auto;
          }
        `}
