                    ...
                    >
                      <div className="single-process">
                        ...
                        <div className="content">
                          ...
                          <p>
                            We begin by understanding your needs, challenges, and goals. Our team consults with you to gather requirements and align expectations.
                          </p>
                        </div>
                      </div>
                    </SwiperSlide>
                    ...
                    >
                      <div className="single-process">
                        ...
                        <div className="content">
                          ...
                          <p>
                            Based on the consultation, we create a customized strategy to address your business objectives with effective IT solutions.
                          </p>
                        </div>
                      </div>
                    </SwiperSlide>
                    ...
                    >
                      <div className="single-process">
                        ...
                        <div className="content">
                          ...
                          <p>
                            We conduct thorough research to analyze market trends, competitors, and opportunities — ensuring your strategy is well-informed and data-driven.
                          </p>
                        </div>
                      </div>
                    </SwiperSlide>
                    ...
                    >
                      <div className="single-process">
                        ...
                        <div className="content">
                          ...
                          <p>
                            With strategy and research in place, we plan a comprehensive campaign — selecting tools, timelines, and resources to maximize success.
                          </p>
                        </div>
                      </div>
                    </SwiperSlide>
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="single-process">
                        ...
                        <div className="content">
                          ...
                          <p>
                            We implement your campaign, monitor progress, and make real-time adjustments to ensure smooth execution and successful outcomes.
                          </p>
                        </div>
                      </div>
                    </SwiperSlide>
