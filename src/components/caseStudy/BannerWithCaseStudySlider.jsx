        ...
        <div className="row g-0">
          <div className="col-xl-4 col-lg-5">
            ...
            <div className="banner-content">
                ...
                >
                  <p>
                    Dive into the success story of BlazeTech Solutions and
                    witness firsthand the transformative journey that
                    exemplifies the impact of BlazeTech solutions.
                  </p>
                  <Link
                    href="/case-study"
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="case-study-card">
                      ...
                      <div className="card-content">
                       ...
                       <h4>
  <Link href="/case-study/case-study-details">
    Digital Transformation Unveiled: The IT Experience.
  </Link>
</h4>
<p>
  This case study unveils the strategic roadmap, the technology stack deployed, and the tangible benefits reaped by Blaze Tech.
</p>
